...
public class DBInfo {
	...
	public static final String MYSQL_USERNAME = "ccs108lucyanne";
	public static final String MYSQL_PASSWORD = "ilahwoon";
	public static final String MYSQL_DATABASE_SERVER = "mysql-user-master.stanford.edu";
	public static final String MYSQL_DATABASE_NAME = "c_cs108_lucyanne";
